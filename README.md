...
Ansible Playbook designed for environments running a ROS app.
It can install and configure these applications that are commonly used in production ROS deployments:
